...
//        icon.setBackground(null);
    ...
    static class EmojiconGridViewPagerAdapter extends PagerAdapter {
        ...
        public EmojiconGridViewPagerAdapter(Context context, @NonNull List<EmojiconPage> pages ,EmojiconGridFragment.OnEmojiconClickedListener listener) {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            emojiGridView.setOnEmojiconClickedListener(mOnEmojiconClickedListener);
